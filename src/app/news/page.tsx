      ...
      <div className="min-h-screen" style={{ color: 'rgb(var(--p-ink))' }}>
        <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-4 pt-24 pb-12">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-semibold" style={{ color: 'rgb(var(--p-ink))' }}>Public news feeds</span>
                  <span 
                ...
                <p className="text-xs" style={{ color: 'rgb(var(--p-ink-dim))' }}>
                  Updates every 6 hours from Google AI, arXiv, BBC Technology, and BBC World. Publication times are shown in UTC.
                </p>
              </div>
              <div className="hidden md:flex items-center gap-4 text-xs" style={{ color: 'rgb(var(--p-ink-dim))' }}>
                ...
                <div className="text-center">
                  <div className="font-semibold" style={{ color: 'rgb(var(--p-sage))' }}>6h</div>
                  <div>Interval</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold" style={{ color: 'rgb(var(--p-sage))' }}>UTC</div>
                  <div>Timezone</div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.footer
            ...
            style={{ color: 'rgb(var(--p-ink-dim))' }}
          >
            <p>Synced from public RSS feeds | Last updated: {newsData.lastUpdated}</p>
          </motion.footer>
        </div>
      </div>
    </PageTransition>
