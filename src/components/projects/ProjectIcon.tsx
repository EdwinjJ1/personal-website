...
const iconMap: Record<string, (props: { size?: number; className?: string }) => ReactNode> = {
  brain: ({ size = 24, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2a5 5 0 0 1 5 5c0 .9-.2 1.7-.7 2.5A5 5 0 0 1 19 14a5 5 0 0 1-3 4.6V22h-4v-3.4A5 5 0 0 1 9 14a5 5 0 0 1 2.7-4.5A5 5 0 0 1 12 2z"/>
      <path d="M12 2v7"/>
      <path d="M9.5 7.5L12 9l2.5-1.5"/>
      <path d="M8 14h8"/>
    </svg>
  ),
  diamond: ({ size = 24, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export default function ProjectIcon({ icon, size = 24, className }: ProjectIconProps) {
  const renderIcon = iconMap[icon ?? 'rocket'] ?? iconMap.rocket;
